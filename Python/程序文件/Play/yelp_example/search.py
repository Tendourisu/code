...
for r in search('Thai'):
    print(r.similar(3))
# [<Thai Basil Cuisine>, <Gypsy's Trattoria Italiano>, <Gypsy's Trattoria Italiano>]
# [<Thai Noodle II>, <La Cascada Taqueria>, <Cafe Milano>]
# [<Thai Basil Cuisine>, <Gypsy's Trattoria Italiano>, <Gypsy's Trattoria Italiano>]
# [<Thai Noodle II>, <La Cascada Taqueria>, <Cafe Milano>]
# [<Jasmine Thai>, <Hummingbird Cafe>, <Hummingbird Cafe>]
# [<Berkeley Thai House>, <Smart Alec's Intelligent Food>, <Smart Alec's Intelligent Food>]
# [<Jasmine Thai>, <Hummingbird Cafe>, <Hummingbird Cafe>]
# [<Berkeley Thai House>, <Smart Alec's Intelligent Food>, <Smart Alec's Intelligent Food>]
# [<Viengvilay Thai Cuisine>, <La Val's Pizza>, <La Val's Pizza>]
# [<Viengvilay Thai Cuisine>, <La Val's Pizza>, <La Val's Pizza>]
